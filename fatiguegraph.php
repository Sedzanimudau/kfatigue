               ...
               <div class="midde_cont">
                  <div class="container-fluid">
                    ...
                    <!DOCTYPE html>
                        ...
                        $sql = "SELECT DATE_FORMAT(date_time, '%H') AS hour_of_operation, COUNT(violation) AS total_fatigue_incidents FROM fatigue WHERE TRIM(violation) = 'Drowsiness detected' AND DATE(date_time) = CURDATE() GROUP BY hour_of_operation";
