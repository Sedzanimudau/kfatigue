                                ...
                                <div class="white_shd full margin_bottom_30">
                                    <div class="full graph_head">
                                        <div class="heading1 margin_0">
                                            <h5 class="title">Fatigue Incidents</h5>
                                            <div class="md-card">
...
$sql="SELECT vehicle_id,camera_id,surname,name,violation,date_time,image FROM demo WHERE TRIM(violation)='Drowsiness detected'";
...
{               ?> 
                                          <tr>
                                             ...
                                             <td>
                                                ...
                                                <?php
                                                // Check if the image URL is not empty before trying to display it
                                                if (!empty($row->image)) {
                                                    // URL encode the image URL
                                                    $encodedImageUrl = rawurlencode($row->image);
                                                    
                                                    echo '<a href="' . htmlentities($row->image) . '" target="_blank">'; // Open the link in a new tab
                                                    echo '<img src="' . htmlentities($encodedImageUrl) . '" width="100" height="100" alt="Image"/>';
                                                    echo '</a>';
                                                } else {
