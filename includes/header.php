                  ...
                  <nav class="navbar navbar-expand-lg navbar-light">
                     <div class="full">
                        ...
                        <div class="logo_section">
                           <a href="dashboard.php"><h3 style="color: white;padding-top: 20px;padding-left: 10px;">Fatigue Monitoring System</h3></a>
                        </div>
...
?>
                                 <li><a href="violations.php"><i class="fa fa-bell-o"></i><span class="badge"><?php echo htmlentities($violations);?></span></a></li>
