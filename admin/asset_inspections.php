                                ...
                                <div class="white_shd full margin_bottom_30">
                                    <div class="full graph_head">
                                        <div class="heading1 margin_0">
                                            <h5 class="title">Asset inspections</h5>
                                            <div class="md-card">
...
$sql="SELECT * FROM tblassetinspection";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?> 
                                          <tr>
                                             ...
                                             <td><?php  echo htmlentities($row->oil);?></td>
                                             <td><?php  echo htmlentities($row->noise);?></td>
                                             <td><?php  echo htmlentities($row->vibration);?></td>
                                             <td><?php  echo htmlentities($row->shift);?></td>
                                             <td><?php  echo htmlentities($row->damage);?></td>
