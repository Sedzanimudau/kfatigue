...
session_start();
error_reporting(0);
include('employee/includes/dbconnection.php');
...
<html lang="en">
   <head>
      ...
      <!-- responsive css -->
      <link rel="stylesheet" href="employee/css/responsive.css" />
      <!-- color css -->
      <link rel="stylesheet" href="employee/css/colors.css" />
      <!-- select bootstrap -->
      <link rel="stylesheet" href="employee/css/bootstrap-select.css" />
      <!-- scrollbar css -->
      <link rel="stylesheet" href="employee/css/perfect-scrollbar.css" />
      <!-- custom css -->
            ...
            <div class="center verticle_center full_height">
               <div class="login_section">
                  <div class="logo_login">
                     <div class="center">
                        <h3 style="color: white;">Fatigue Monitoring System</h3>
                     </div>
                  </div>
                  <div class="login_form">
                     <form method="post" name="login">
                        ...
                        <a class="forgot" href="admin/login.php">Admin</a>
                     </form>
                  </div>
               </div>
            </div>
